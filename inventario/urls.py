...
from inventario.views import (
    ...
    usuarios_lista,
    venta_comprobante,
    venta_comprobante_pdf,
    venta_crear,
    venta_editar,
    venta_eliminar,
    venta_guardada,
    ventas_exportar_excel,
    ventas_exportar_pdf,
    ventas_lista,
)
...
urlpatterns = [
    ...
    path('inventario/ingresos/', include('inventario.ingresos.urls')),
    ...
    path('ventas/<int:pk>/editar/', venta_editar, name='venta_editar'),
    path('ventas/<int:pk>/eliminar/', venta_eliminar, name='venta_eliminar'),
    path('ventas/<int:pk>/comprobante/', venta_comprobante, name='venta_comprobante'),
    path('ventas/<int:pk>/comprobante/pdf/', venta_comprobante_pdf, name='venta_comprobante_pdf'),
    path('ventas/exportar/pdf/', ventas_exportar_pdf, name='ventas_exportar_pdf'),
    path('ventas/exportar/excel/', ventas_exportar_excel, name='ventas_exportar_excel'),
